...
import pic3 from './images/nature 1.jpg'  
...
<div className='container'>
   ...
   <div className='row'>
     <div className='col-md-8 p-4'>
          ...
          <p className='pt-1' style={{fontFamily:'inherit'}}>The year 2024 has been <b>a milestone for global development as governments
